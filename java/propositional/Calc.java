...
/**
 * SIMPLE PROPOSITIONAL TREE – Beginner Mode Part of the TreeOfKnowledge.eu project.
 *
 ...
 *
 * <p>This class initializes the application, parses the user input formula, builds its abstract
 * syntax tree (AST), and triggers the recursive evaluation and visualization of the propositional
 * tree.
 *
 * <p>Its responsibilities include:
 *
 * <ul>
 *   <li>Reading and validating the input formula.
 *   <li>Invoking the parser to construct the internal tree representation.
 *   <li>Starting the evaluation of the formula under all truth assignments.
 *   <li>Coordinating the display of the logical tree and results (GUI / console).
 * </ul>
 *
 * <p>Conceptually, this class represents the “root” of the calculator: it does not implement
 * logical operators itself, but orchestrates the entire process from syntax (parsing) through
 * semantics (truth evaluation) to visualization, making it suitable as a didactic entry point for
...
class Calc extends JFrame implements ActionListener {
  ...
  public Calc() {
    ...
    // @SIMPLE LOOK Nice - Needed here ONLY
  ...
  public void actionPerformed(ActionEvent event) {
    ...
    if (action.equals(enter)) {
      ...
      try {
        ...
        // @SIMPLE SHOW Tree - BRIJEM da ovo NE treba!-.-?
  ...
  private void resetToInitialState() {
    ...
    // @SIMPLE LOOK Nice - PRIVEREMENO RJEŠENJE
    stablaPanel.add(UIStrings.NNF_INFO_HTML, JLabel.CENTER);
    stablaPanel.add(UIStrings.FORMULA_INFO_HTML, JLabel.CENTER);
