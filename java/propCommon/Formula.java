...
public abstract class Formula implements Cloneable {
  ...
  // @GPT: Consider adding an abstract method for converting to normal forms
  // (CNF/DNF) if needed by the calculator. This would allow each formula type to
  // implement its own logic for normalization, which can be useful for the
  // minimization process.
  // static {
  // System.out.println("USING Formula class: " + Formula.class.getName());
  // }
