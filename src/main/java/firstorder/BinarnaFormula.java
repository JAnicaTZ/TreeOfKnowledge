 ...
 *
 * <ul>
 *   <li>Visualization: {@link #prikazFormule()} creates a binary node in the output tree,
 *   <li>Normalization/testing pipeline: {@link #glavniTestLogikePrvogReda()} applies the same
 *       process recursively to both children,
 *   <li>Domain evaluation: {@link #glavniTest(int)} delegates the domain-bounded test to both
 *       children.
 * </ul>
 *
