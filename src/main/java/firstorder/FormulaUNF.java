 ...
 *
 * <ul>
 *   <li>Extraction of a conjunction-oriented list representation via {@link #konjuktivnaForma()},
 *   <li>A domain-bounded semantic test via {@link #glavniTest(int)}.
 * </ul>
 *
...
public abstract class FormulaUNF extends Formula {
  ...
  public abstract Formula glavniTest(
      int brojElemenataNosaca); // brojKonstanti || brojElemenataDomene
}
