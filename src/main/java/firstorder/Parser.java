      ...
      switch (formula.charAt(i++)) {
        ...
        case Calc.POVLACI_CHAR:
          ...
          ((Negacija) ((BinarnaFormula) binarniVeznik).lijevoPodStablo).podStablo.prefix =
              ((Negacija) ((BinarnaFormula) binarniVeznik).lijevoPodStablo)
                  .podStablo.prefix.substring(prefix.length());
          break;
    ...
    switch (formula.charAt(i)) {
      ...
      case Calc.Q_CHAR:
        ...
        if (!mapKoristeneVarijable.containsKey(
          ...
          if (!((Integer)
                  mapKoristeneVarijable.get(new Character(atomarnaFormula.charAt(0)).toString()))
