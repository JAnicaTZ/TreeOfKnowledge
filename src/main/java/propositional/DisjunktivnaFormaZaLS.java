...
public class DisjunktivnaFormaZaLS {
  ...
  public static void disjunktivnaFormaZaLS() throws FaktorExpected, Pocetak, ZatvoriZagradu {
    ...
    OsvjetljivanjeRjesenja.osvijetliRjesenja(
        ...
        reducirajNormalnuFormu(((FormulaUNormalnoj) eliminiramNegacije).disjunktivnojFormi()));
  ...
  /**
   * Removes redundant conjunctive clauses from a DNF. If clause A is a subset of clause B, then B
   * is redundant (A implies B).
   */
