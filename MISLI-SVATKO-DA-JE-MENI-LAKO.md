...
- tolerate ambiguity without inventing unsupported facts;
...
A donation does not automatically create ownership.

A sponsorship does not automatically create technical authority.

A grant does not automatically transfer intellectual property.

An investment does not automatically permit unrestricted control.

A commercial partnership does not automatically make TREE exclusive.

Every financial arrangement must therefore define in writing:

- what is being provided;
- what the supporter receives in return;
- whether repayment or revenue sharing is expected;
- whether intellectual-property rights are involved;
- whether publicity or attribution is required;
- what authority—if any—is granted;
...
«The smallest honest amount of support capable of producing the next independently verifiable result.»

TREE should never be sold cheaply merely because its present bank balance is small. 🌳
